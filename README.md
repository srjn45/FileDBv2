...
[![CI](https://github.com/srjn45/scriva/actions/workflows/ci.yml/badge.svg)](https://github.com/srjn45/scriva/actions/workflows/ci.yml)
[![Go Report Card](https://goreportcard.com/badge/github.com/srjn45/scriva)](https://goreportcard.com/report/github.com/srjn45/scriva)
...
See [Getting Started](docs/getting-started.md) for Scoop, apt/rpm, and AUR channels.
...
`scriva-data` volume. See [`docker-compose.yml`](docker-compose.yml) and the
fully commented [`scriva.example.yaml`](scriva.example.yaml) for configuration.
...
Prefer to generate your own? The checked-in [OpenAPI spec](docs/openapi/scriva.swagger.json)
